function [X, cost] = OpWeightedTV_PD_ALG2(b,edgemask,lambda,A,At,res,Niter)
...
%  
% Note this implementation is an adaptation of the ALG2 algorithm from:
...
lambda0 = 2/lambda; %rescale lambda to give the equivalent problem in Chambolle & Pock

%ALG 2 in Chambolle & Pock
gamma = 0.7*lambda0;
L = sqrt(12); %Lipschitz constant of 3-D finite difference
tau = 1/L;
sigma = 1/((L^2)*tau);
